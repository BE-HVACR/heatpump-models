...
model VariableSpeed "Variable speed water source DX coils"
  extends DXSystems.Heating.BaseClasses.PartialWaterHeatedDXCoil(redeclare final
            DXSystems.Heating.WaterSource.VariableSpeedAirSource con(final
        minSpeRat=minSpeRat, final speRatDeaBan=speRatDeaBan));
...
equation
  ...
  connect(speRat,con.speRat)  annotation (Line(points={{-112,80},{-16,80},{-16,
          8},{-11,8}},
                     color={0,0,127}));
