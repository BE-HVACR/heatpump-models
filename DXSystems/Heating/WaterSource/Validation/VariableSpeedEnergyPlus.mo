within DXSystems.Heating.WaterSource.Validation;
model VariableSpeedEnergyPlus
  ...
  VariableSpeedAirSource varSpeDX(
  ...
  parameter DXSystems.Heating.WaterSource.Data.Generic.DXCoil datCoi(
    nSta=10,
    minSpeRat=0.1,
    sta={DXSystems.Heating.WaterSource.Data.Generic.BaseClasses.Stage(
        spe=500/60,
        nomVal=
