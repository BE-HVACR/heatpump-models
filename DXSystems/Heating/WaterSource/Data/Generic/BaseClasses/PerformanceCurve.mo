within DXSystems.Heating.WaterSource.Data.Generic.BaseClasses;
record PerformanceCurve "Data record for a performance curve"
  extends DXSystems.Cooling.AirSource.Data.Generic.BaseClasses.PerformanceCurve;
//-----------------------------Performance curves-----------------------------//

  parameter Real capFunFFSou[:]
    "Polynomial coefficients for heating capacity function of water flow fration at condensers"
    annotation (Dialog(group="Performance curves"));

  parameter Real EIRFunFFSou[:]
    "Polynomial coefficients for EIR function of water flow fration at condensers"
    annotation (Dialog(group="Performance curves"));
//------------------------Range for performance curves------------------------//

  parameter Real ffSouMin
