within DXSystems.Heating.WaterSource;
model VariableSpeedAirSource "Variable speed DX cooling coil"
  extends DXSystems.Heating.BaseClasses.PartialDXHeatingCoilWaterSource(dxCoi(
        final variableSpeedCoil=true, dryCoi(redeclare
          DXSystems.BaseClasses.CapacityAirSource coiCap)), use_mCon_flow=false);
...
equation
  ...
  connect(deaBan.y, onSwi.u) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(dxCoi.mWat_flow, vol.mWat_flow) annotation (Line(points={{1,44},{12,44},
          {12,30},{-20,30},{-20,-18},{-11,-18}}, color={0,0,127}));
