within DXSystems.Heating.WaterSource.Examples.PerformanceCurves;
record Curve_I "Curve_I"
  extends
    DXSystems.Heating.WaterSource.Data.Generic.BaseClasses.PerformanceCurve(
    each capFunT={1.43085,-0.0453653,0.00199378,-0.00805944,3.93414E-05,-1.81187E-04},
    each capFunFF={1.0,0.0,0,0},
    each capFunFFSou={1.0,0.0,0.0},
    each EIRFunT={0.138848,0.0457985,-0.00138661,0.0141485,0.000386055,-4.38194E-04},
    each EIRFunFF={1.0,0.0,0.0},
    each EIRFunFFSou={1.0,0.0,0.0},
