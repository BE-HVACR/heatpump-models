...
model SingleSpeed_TimedResistiveDefrost
  ...
  extends DXSystems.Heating.AirSource.Validation.BaseClasses.SingleSpeedHeating(
      datRea(final fileName=ModelicaServices.ExternalReferences.loadResource(
          "modelica://Buildings/Resources/Data/Fluid/DXSystems/Heating/AirSource/Validation/SingleSpeedHeating_TimedResistiveDefrost/DXCoilSystemAuto.dat")),
      datCoi(final defOpe=DXSystems.Heating.BaseClasses.Types.DefrostOperation.resistive,
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-180,-160},
            {180,160}})),
             __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Heating/AirSource/Validation/SingleSpeed_TimedResistiveDefrost.mos"
        "Simulate and Plot"),
