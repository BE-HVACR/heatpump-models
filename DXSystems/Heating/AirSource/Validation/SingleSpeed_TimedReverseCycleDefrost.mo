within DXSystems.Heating.AirSource.Validation;
model SingleSpeed_TimedReverseCycleDefrost
  "Validation model for single speed heating DX coil with defrost operation"

  extends Modelica.Icons.Example;
  extends DXSystems.Heating.AirSource.Validation.BaseClasses.SingleSpeedHeating(
      datRea(final fileName=ModelicaServices.ExternalReferences.loadResource(
          "modelica://Buildings/Resources/Data/Fluid/DXSystems/Heating/AirSource/Validation/SingleSpeedHeating_TimedReverseCycleDefrost/DXCoilSystemAuto.dat")),
      datCoi(final defOpe=DXSystems.Heating.BaseClasses.Types.DefrostOperation.reverseCycle,
        final defTri=DXSystems.Heating.BaseClasses.Types.DefrostTimeMethods.timed));

  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-180,-160},
            {180,160}})),
             __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Heating/AirSource/Validation/SingleSpeed_TimedReverseCycleDefrost.mos"
        "Simulate and Plot"),
...
end SingleSpeed_TimedReverseCycleDefrost;
