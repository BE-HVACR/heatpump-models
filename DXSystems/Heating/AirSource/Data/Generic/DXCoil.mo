within DXSystems.Heating.AirSource.Data.Generic;
record DXCoil
  ...
  replaceable parameter
    DXSystems.Heating.AirSource.Data.Generic.BaseClasses.Stage sta[nSta]
  ...
  parameter DXSystems.Heating.BaseClasses.Types.DefrostOperation defOpe=DXSystems.Heating.BaseClasses.Types.DefrostOperation.resistive
    "Defrost operation type";

  parameter DXSystems.Heating.BaseClasses.Types.DefrostTimeMethods defTri=DXSystems.Heating.BaseClasses.Types.DefrostTimeMethods.timed
  ...
  parameter Real tDefRun(
    ...
    annotation(Dialog(enable=defTri == DXSystems.Heating.BaseClasses.Types.DefrostTimeMethods.timed));
  ...
  parameter Modelica.Units.SI.HeatFlowRate QDefResCap(min=0)
    ...
    annotation(Dialog(enable=defOpe == DXSystems.Heating.BaseClasses.Types.DefrostOperation.resistive));
...
//-----------------------------Performance curves-----------------------------//
  parameter Real defEIRFunT[6] = fill(0,6)
    ...
    annotation (Dialog(enable=defOpe == DXSystems.Heating.BaseClasses.Types.DefrostOperation.reverseCycle));
