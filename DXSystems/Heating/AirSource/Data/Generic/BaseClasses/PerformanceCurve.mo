within DXSystems.Heating.AirSource.Data.Generic.BaseClasses;
record PerformanceCurve "Data record for a performance curve"
  extends Modelica.Icons.Record;
//-----------------------------Performance curves-----------------------------//
  parameter Real  capFunT[6]
    "Biquadratic coefficients for heating capacity function of temperature"
    annotation (Dialog(group="Performance curves"));
  parameter Real  capFunFF[:]
    "Polynomial coefficients for heating capacity function of flow fration"
    annotation (Dialog(group="Performance curves"));
...
//------------------------Range for performance curves------------------------//
  parameter Modelica.Units.SI.Temperature TConInMin
    "Minimum condenser inlet temperature for heating capacity function"
    annotation (Dialog(group="Minimum and maximum values"));
  parameter Modelica.Units.SI.Temperature TConInMax
    "Maximum condenser inlet temperature for heating capacity function"
    annotation (Dialog(group="Minimum and maximum values"));
  parameter Modelica.Units.SI.Temperature TEvaInMin
    "Minimum evaporator inlet temperature for heating capacity function"
    annotation (Dialog(group="Minimum and maximum values"));
  parameter Modelica.Units.SI.Temperature TEvaInMax
    "Maximum evaporator inlet temperature for heating capacity function"
    annotation (Dialog(group="Minimum and maximum values"));
