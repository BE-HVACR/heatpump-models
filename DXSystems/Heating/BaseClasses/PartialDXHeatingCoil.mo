...
partial model PartialDXHeatingCoil
  ...
  DXSystems.BaseClasses.DryCoil dxCoi(
    final datCoi=datCoi,
...
protected
  ...
  DXSystems.Heating.BaseClasses.CoilDefrostTimeCalculations defTimFra(
  ...
  DXSystems.Heating.BaseClasses.DefrostCapacity defCap(
