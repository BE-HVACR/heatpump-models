...
protected
  DXSystems.Cooling.BaseClasses.SpeedShift speShiEIR(
  ...
  DXSystems.Cooling.BaseClasses.SpeedShift speShiQ_flow(
    final variableSpeedCoil=variableSpeedCoil,
    final nSta=nSta,
...
equation
  ...
  connect(speShiQ_flow.y, Q_flow) annotation (Line(points={{46.7,51},{80,51},{
