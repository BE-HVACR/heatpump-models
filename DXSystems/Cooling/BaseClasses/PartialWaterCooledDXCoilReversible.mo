...
model PartialWaterCooledDXCoilReversible "Base class for water source DX coils"
  extends Buildings.BaseClasses.BaseIcon;
  extends DXSystems.Cooling.BaseClasses.EssentialParametersReversible(
      redeclare DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoi,
      redeclare DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoiHea);
  ...
  // Components
  replaceable DXSystems.Cooling.BaseClasses.PartialDXCooHeaCoil loa
    constrainedby DXSystems.Cooling.BaseClasses.PartialDXCooHeaCoil(
    redeclare final package Medium = MediumEva,
    redeclare final DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoi=
        datCoi,
    redeclare final DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoiHea
      =datCoiHea,
    dxCoi(
      redeclare final DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoi=
          datCoi,
      redeclare final DXSystems.Cooling.WaterSource.Data.Generic.DXCoil
        datCoiHea=datCoiHea,
      wetCoi(
        redeclare final DXSystems.Cooling.BaseClasses.CapacityWaterCooled
          coiCap,
        redeclare final DXSystems.Cooling.WaterSource.Data.Generic.DXCoil
          datCoi=datCoi,
        appDewPt(redeclare final
            DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoi=datCoi,
            uacp(redeclare final
              DXSystems.Cooling.WaterSource.Data.Generic.BaseClasses.NominalValues
              per))),
      dryCoi(redeclare final DXSystems.Cooling.BaseClasses.CapacityWaterCooled
          coiCap, redeclare final
          DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoi=datCoi),
      dryCoiHea(redeclare final
          DXSystems.Cooling.BaseClasses.CapacityWaterCooled coiCap, redeclare final
                DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoi=
            datCoiHea)),
...
protected
  ...
  Modelica.Blocks.Sources.RealExpression u(final y=if loa.dxCoi.Q_flow < 0 then (-loa.dxCoi.Q_flow +loa.P) /(-
        datCoi.sta[nSta].nomVal.Q_flow_nominal*(1 + 1/datCoi.sta[nSta].nomVal.COP_nominal)) else (loa.dxCoi.Q_flow
         -loa.P) /(datCoi.sta[nSta].nomVal.Q_flow_nominal*(1 - 1/datCoi.sta[nSta].nomVal.COP_nominal)))
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFloCon(redeclare final package
      Medium =         MediumCon) "Mass flow through condenser"
...
equation
  connect(u.y, watCooCon.u) annotation (Line(points={{-14.7,-60},{-8,-60},{-8,-74},
          {-18,-74}},
                    color={0,0,127}));
  connect(loa.port_b, port_b)
    annotation (Line(points={{10,0},{100,0}},           color={0,127,255}));
  connect(loa.port_a, port_a)
    annotation (Line(points={{-10,0},{-100,0}},            color={0,127,255}));
  connect(watCooCon.port_b, portCon_b) annotation (Line(points={{-40,-80},{-60,-80},
          {-60,-100}}, color={0,127,255}));
  connect(loa.P, P) annotation (Line(points={{11,9},{40,9},{40,90},{110,90}},
        color={0,0,127}));
  connect(loa.QSen_flow, QSen_flow) annotation (Line(points={{11,7},{44,7},{44,
          60},{110,60}}, color={0,0,127}));
  connect(loa.QLat_flow, QLat_flow) annotation (Line(points={{11,5},{48,5},{48,
          30},{110,30}}, color={0,0,127}));
  connect(watCooCon.port_a, senMasFloCon.port_b)
    annotation (Line(points={{-20,-80},{20,-80}},color={0,127,255}));
  connect(senMasFloCon.m_flow,loa. mCon_flow) annotation (Line(points={{30,-69},
          {30,-30},{-20,-30},{-20,-3},{-11,-3}},                       color={0,
          0,127}));
  connect(TConEntWat.y,loa. TOut) annotation (Line(points={{-39,11},{-20,11},{-20,
...
end PartialWaterCooledDXCoilReversible;
