...
partial block EssentialParametersReversible
  "A partial block for essential parameters for cooling DX coils"

 replaceable parameter DXSystems.Cooling.AirSource.Data.Generic.DXCoil datCoi
    "Performance data for cooling"
    annotation (Placement(transformation(extent={{-80,82},{-68,94}})));

 replaceable parameter DXSystems.Cooling.AirSource.Data.Generic.DXCoil datCoiHea
    "Performance data for heating"
...
end EssentialParametersReversible;
