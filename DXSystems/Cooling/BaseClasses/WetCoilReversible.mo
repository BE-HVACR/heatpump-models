...
model WetCoilReversible "Calculates wet coil condition"
  extends PartialCoilConditionReversible;
  ...
  DXSystems.Cooling.BaseClasses.ApparatusDewPoint appDewPt(
  ...
  DXSystems.Cooling.BaseClasses.SensibleHeatRatio shr(redeclare package Medium =
        Medium) "Calculates sensible heat ratio"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  DXSystems.Cooling.BaseClasses.Condensation conRat
...
equation
  ...
  connect(speShiQ_flow.y, appDewPt.Q_flow) annotation (Line(points={{66.7,51},{
          90,51},{90,-32},{-34,-32},{-34,-46.1},{-31,-46.1}},
                                                       color={0,0,127}));
  connect(speShiQ_flow.y, conRat.Q_flow) annotation (Line(points={{66.7,51},{90,
          51},{90,-32},{58,-32},{58,-76},{59,-76}},
                                               color={0,0,127}));
