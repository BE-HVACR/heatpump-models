...
model SpeedShift "Test model for SpeedShift block"
 ...
 parameter Integer nSta=4 "Number of standard compressor speeds";
  DXSystems.Cooling.BaseClasses.SpeedShift speShi(
    nSta=nSta,
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Cooling/BaseClasses/Examples/SpeedShift.mos"
        "Simulate and plot"),
          Documentation(info="<html>
<p>
This example illustrates working of SpeedShift block
<a href=\"modelica://Buildings.Fluid.DXSystems.Cooling.BaseClasses.SpeedShift\">
Buildings.Fluid.DXSystems.Cooling.BaseClasses.SpeedShift</a>.
</p>
</html>",
revisions="<html>
<ul>
