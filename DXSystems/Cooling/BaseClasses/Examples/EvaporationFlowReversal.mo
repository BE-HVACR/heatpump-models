...
model EvaporationFlowReversal
  ...
  parameter DXSystems.Cooling.AirSource.Data.Generic.BaseClasses.NominalValues nomVal(
    Q_flow_nominal=-5000,
    COP_nominal=3,
    SHR_nominal=0.8,
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Cooling/BaseClasses/Examples/EvaporationFlowReversal.mos"
        "Simulate and plot"),
