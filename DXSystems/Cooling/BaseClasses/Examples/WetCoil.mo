...
model WetCoil "Test model for WetCoil"
 ...
 package Medium =  Buildings.Media.Air;
  ...
  DXSystems.Cooling.BaseClasses.WetCoil wetCoi(
    redeclare package Medium = Medium,
    datCoi=datCoi,
    variableSpeedCoil=true,
    use_mCon_flow=false,
    redeclare DXSystems.BaseClasses.CapacityAirSource coiCap)
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Cooling/BaseClasses/Examples/WetCoil.mos"
        "Simulate and plot"),
