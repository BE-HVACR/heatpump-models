...
model CoolingCapacityWaterCooled "Test model for CoolingCapacityWaterCooled"
  ...
  DXSystems.Cooling.BaseClasses.CapacityWaterCooled cooCap(sta={sta}, nSta=1)
  ...
  parameter DXSystems.Cooling.WaterSource.Data.Generic.BaseClasses.Stage sta(
    nomVal(
      ...
      mCon_flow_nominal=1),
    perCur=
        DXSystems.Cooling.BaseClasses.Examples.PerformanceCurves.Curve_I_WaterCooled(),
