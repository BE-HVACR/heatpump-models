...
partial model PartialDXCoilReversible
  ...
  replaceable DXSystems.Cooling.BaseClasses.PartialCoilInterfaceReversible dxCoi
    constrainedby DXSystems.Cooling.BaseClasses.PartialCoilInterfaceReversible(
    datCoi=datCoi,
    datCoiHea=datCoiHea,
    final use_mCon_flow=use_mCon_flow) "DX coil"
