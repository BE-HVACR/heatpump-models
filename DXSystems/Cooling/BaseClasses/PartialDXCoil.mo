...
partial model PartialDXCoil
  ...
  replaceable DXSystems.Cooling.BaseClasses.PartialCoilInterface dxCoi
    constrainedby DXSystems.Cooling.BaseClasses.PartialCoilInterface(datCoi=
        datCoi, final use_mCon_flow=use_mCon_flow) "DX coil"
