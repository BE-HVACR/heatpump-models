...
partial model PartialDXCooHeaCoil
  "Partial model for DX cooling coil"
  extends DXSystems.Cooling.BaseClasses.PartialDXCoilReversible(
    redeclare DXSystems.Cooling.BaseClasses.DXCooHea dxCoi(
      redeclare final package Medium = Medium,
      redeclare DXSystems.Cooling.AirSource.Data.Generic.DXCoil datCoi,
      redeclare DXSystems.Cooling.AirSource.Data.Generic.DXCoil datCoiHea),
  ...
  DXSystems.Cooling.BaseClasses.Evaporation watVapEva(
    redeclare final package Medium = Medium,
...
protected
  DXSystems.Cooling.BaseClasses.InputPowerReversible pwr
