...
model SingleSpeed "Test model for single speed DX coil"
  ...
  DXSystems.Cooling.WaterSource.SingleSpeed sinSpeDX(
  ...
  parameter DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoi(nSta=1,
...
equation
  ...
  annotation (             __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Cooling/WaterSource/Examples/SingleSpeed.mos"
        "Simulate and plot"),
