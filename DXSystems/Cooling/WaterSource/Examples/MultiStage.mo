within DXSystems.Cooling.WaterSource.Examples;
model MultiStage "Test model for multi speed water source DX coil"
  ...
  DXSystems.Cooling.WaterSource.MultiStage mulSpeDX(
  ...
  parameter DXSystems.Cooling.WaterSource.Data.Generic.DXCoil datCoi(nSta=4,
...
equation
  ...
  annotation (             __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Cooling/WaterSource/Examples/MultiStage.mos"
        "Simulate and plot"),
    experiment(Tolerance=1e-6, StopTime=3600),
            Documentation(info="<html>
<p>
This is a test model for
<a href=\"modelica://Buildings.Fluid.DXSystems.Cooling.WaterSource.MultiStage\">
Buildings.Fluid.DXSystems.Cooling.WaterSource.MultiStage</a>.
