within DXSystems.Cooling.WaterSource;
model VariableSpeed "Variable speed water source DX coils"
  extends DXSystems.Cooling.BaseClasses.PartialWaterCooledDXCoil(redeclare final
            DXSystems.Cooling.AirSource.VariableSpeed eva(final minSpeRat=
          minSpeRat, final speRatDeaBan=speRatDeaBan));
