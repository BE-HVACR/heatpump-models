within DXSystems.Cooling.AirSource.Examples;
model SpaceCooling "Space cooling with DX coils"
  ...
  parameter DXSystems.Cooling.AirSource.Data.Generic.DXCoil datCoi(sta={
        ...
        perCur=DXSystems.Cooling.AirSource.Examples.PerformanceCurves.Curve_I())},
      nSta=1) "Data record for single-speed coil"
    annotation (Placement(transformation(extent={{0,-40},{20,-20}})));

  parameter DXSystems.Cooling.AirSource.Data.Generic.DXCoil datCoiMulSpe(nSta=2,
      sta={DXSystems.Cooling.AirSource.Data.Generic.BaseClasses.Stage(
        spe=900/60,
        nomVal=
          DXSystems.Cooling.AirSource.Data.Generic.BaseClasses.NominalValues(
  ...
  DXSystems.Cooling.AirSource.SingleSpeed sinSpeDX(
    redeclare package Medium = Medium,
    final datCoi=datCoi,
  ...
  DXSystems.Cooling.AirSource.MultiStage mulStaDX(
    redeclare package Medium = Medium,
    final dp_nominal=400,
  ...
  DXSystems.Cooling.AirSource.VariableSpeed varSpeDX(
    redeclare package Medium = Medium,
    final dp_nominal=400,
    final datCoi=datCoiMulSpe,
    final minSpeRat=0.2,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://Buildings/Resources/Images/Fluid/DXSystems/Cooling/AirSource/Examples/SpaceCooling.png\" />
</p>
