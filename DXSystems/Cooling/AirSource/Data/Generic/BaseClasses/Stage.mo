within DXSystems.Cooling.AirSource.Data.Generic.BaseClasses;
record Stage "Generic data record for a stage of a air source DX coil"
  ...
  replaceable parameter
    DXSystems.Cooling.AirSource.Data.Generic.BaseClasses.NominalValues nomVal
    "Nominal values"
    annotation (Placement(transformation(extent={{60,60},{80,80}})));

  replaceable parameter
    DXSystems.Cooling.AirSource.Data.Generic.BaseClasses.PerformanceCurve perCur
    "Performance curves for this stage" annotation (choicesAllMatching=true,
