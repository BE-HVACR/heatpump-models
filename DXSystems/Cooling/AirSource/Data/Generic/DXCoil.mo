within DXSystems.Cooling.AirSource.Data.Generic;
record DXCoil
  ...
  replaceable parameter
    DXSystems.Cooling.AirSource.Data.Generic.BaseClasses.Stage sta[nSta]
  ...
  final parameter DXSystems.Heating.BaseClasses.Types.DefrostOperation defOpe=DXSystems.Heating.BaseClasses.Types.DefrostOperation.resistive
    "Defrost operation type" annotation (HideResult=true);

  final parameter DXSystems.Heating.BaseClasses.Types.DefrostTimeMethods defTri=DXSystems.Heating.BaseClasses.Types.DefrostTimeMethods.timed
