within DXSystems.Cooling.AirSource.Validation;
model SingleSpeedPLR
  ...
  parameter DXSystems.Cooling.AirSource.Data.Generic.DXCoil datCoi(nSta=1, sta=
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-160,-140},
            {160,140}})),
             __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Cooling/AirSource/Validation/SingleSpeedPLR.mos"
        "Simulate and plot"),
