within DXSystems.Reversible.WaterSource.Validation;
model VariableSpeedEnergyPlus
  ...
  WaterSource.VariableSpeed varSpeDX(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) "Variable speed DX coil"
    annotation (Placement(transformation(extent={{-10,0},{10,20}})));

  parameter Data.Generic.DXCoil datCoi(
    nSta=10,
    minSpeRat=0.1,
    sta={Data.Generic.BaseClasses.Stage(
        ...
        nomVal=Data.Generic.BaseClasses.NominalValues(
          ...
          TEvaIn_nominal=273.15 + 19.44,
          TConIn_nominal=273.15 + 29.4,
          phiIn_nominal=0.5148),
        perCur=Examples.PerformanceCurves.Curve_I()),Data.Generic.BaseClasses.Stage(
        spe=1000/60,
        nomVal=Data.Generic.BaseClasses.NominalValues(
        ...
        nomVal=Data.Generic.BaseClasses.NominalValues(
          ...
          TConIn_nominal=273.15 + 29.4,
          phiIn_nominal=0.5148),
        perCur=Examples.PerformanceCurves.Curve_I())}) "Coil data"
  ...
  Buildings.Fluid.Sources.Boundary_pT sinWat(
    ...
    nPorts=1,
    p(displayUnit="Pa")) "Sink on water side" annotation (Placement(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TConOut(m_flow_nominal=
        0.38, redeclare package Medium = MediumWater)
    "Outlet temperature at the condenser"
...
equation
  ...
  connect(masConIn.y, souWat.m_flow_in) annotation (Line(points={{139,10},{80,
          10},{80,-22},{60,-22}},
                              color={0,0,127}));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-160,
          ...
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/Cooling/WaterSource/Validation/VariableSpeedEnergyPlus.mos"
        "Simulate and plot"),
