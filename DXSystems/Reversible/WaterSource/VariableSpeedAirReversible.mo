...
model VariableSpeedAirReversible "Variable speed DX cooling coil"
  extends DXSystems.Cooling.BaseClasses.PartialDXCooHeaCoil2(dxCoi(
      final variableSpeedCoil=true,
      wetCoi(redeclare DXSystems.BaseClasses.CapacityAirSource coiCap),
      dryCoi(redeclare DXSystems.BaseClasses.CapacityAirSource coiCap),
      dryCoiHea(redeclare DXSystems.BaseClasses.CapacityAirSource coiCap)),
      use_mCon_flow=false);
...
equation
  ...
  connect(deaBan.y, onSwi.u) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(uMod, dxCoi.uMod)
    annotation (Line(points={{-110,-80},{-32,-80},{-32,10},{-10,10},{-10,41}}, color={255,127,0}));
  connect(uMod, pwr.uMod) annotation (Line(points={{-110,-80},{-32,-80},{-32,10},
          {30,10},{30,59}}, color={255,127,0}));
...
First implementation.
    ...
    Icon(graphics={Text(
          ...
          textString="speRat"),
              ...
              127})}));
end VariableSpeedAirReversible;
